export default function AcceptableUsePolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3">About us</h2>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
        This acceptable use policy sets out the terms between you and us under which you may access our website{" "}
        <a href="https://www.wtf-giveaways.co.uk" className="text-pink-500 hover:underline">www.wtf-giveaways.co.uk</a> (our site). This acceptable use policy applies to all users of, and visitors to, our site.
      </p>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
        ...
        <a href="/legal/website-terms-of-use" className="text-pink-500 hover:underline">terms of website use</a>.
      </p>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
        Our site is a site operated by WTF GIVEAWAYS LTD (&quot;We&quot;). We are registered in England and Wales under company number 17038774 and have our registered office at 16 Green Drive, Thornton-Cleveleys, United Kingdom, FY5 1LQ.
      </p>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
      ...
      <ul className="list-disc list-inside text-sm leading-relaxed text-muted-foreground space-y-2 mb-4">
      ...
      <ul className="list-disc list-inside text-sm leading-relaxed text-muted-foreground space-y-2 mb-4">
        <li>Not to reproduce, duplicate, copy or re-sell any part of our site in contravention of the provisions of our{" "}
          <a href="/legal/website-terms-of-use" className="text-pink-500 hover:underline">terms of website use</a>.
        </li>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3">Interactive services</h2>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3">Content standards</h2>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
      ...
      <ul className="list-disc list-inside text-sm leading-relaxed text-muted-foreground space-y-1 mb-4">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3">Suspension and termination</h2>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
      ...
      <p className="text-sm leading-relaxed text-muted-foreground mb-2">
        ...
        <a href="/legal/website-terms-of-use" className="text-pink-500 hover:underline">terms of use</a> upon which you are permitted to use our site, and may result in our taking all or any of the following actions:
      </p>
      <ul className="list-disc list-inside text-sm leading-relaxed text-muted-foreground space-y-1 mb-4">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3">Changes to the acceptable use policy</h2>
      <p className="text-sm leading-relaxed text-muted-foreground mb-4">
